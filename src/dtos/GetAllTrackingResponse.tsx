...
export class Convert {
  public static toGetAllUserTrackingResponse(
    json: string
  ): GetAllUserTrackingResponse {
    return cast(JSON.parse(json), r("GetAllUserTrackingResponse"));
  }

  public static GetAllUserTrackingResponseToJson(
    value: GetAllUserTrackingResponse
  ): string {
    return JSON.stringify(
      uncast(value, r("GetAllUserTrackingResponse")),
      null,
      2
    );
  }
...
const typeMap: any = {
  ...
  Past: o(
    [
      ...
      { json: "isExpense", js: "isExpense", typ: true },
